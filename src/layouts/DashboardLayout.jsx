...
const navigation = [
  ...
  { name: 'Portfolio', href: '/portfolio', icon: DocumentChartBarIcon },
  { name: 'Wallet', href: '/wallet', icon: WalletIcon },
  { name: 'Reports', href: '/reports', icon: Cog6ToothIcon },
]
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-200">
          ...
          <div className="fixed inset-0 flex">
            ...
            >
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-600 dark:bg-gray-800 px-6 pb-4 transition-colors duration-200">
      ...
      <div className="lg:pl-72">
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 transition-colors duration-200">
          <button
            type="button"
            className="-m-2.5 p-2.5 text-gray-700 dark:text-gray-200 lg:hidden transition-colors duration-200"
          ...
          {/* Separator */}
          <div className="h-6 w-px bg-gray-200 dark:bg-gray-700 lg:hidden transition-colors duration-200" aria-hidden="true" />
